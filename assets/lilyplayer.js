...
var wasmBinaryFile;
  wasmBinaryFile = 'lilyplayer.wasm';
...
var ASM_CONSTS = {
  25434516: function($0) {const accept = UTF8ToString($0); var fileElement = document.createElement("input"); document.body.appendChild(fileElement); fileElement.type = "file"; fileElement.style = "display:none"; fileElement.accept = accept; fileElement.onchange = function(event) { const files = event.target.files; for (var i = 0; i < files.length; i++) { const file = files[i]; var reader = new FileReader(); reader.onload = function() { var contentArray = new Uint8Array(reader.result); const contentSize = reader.result.byteLength; const heapPointer = _malloc(contentSize); const heapBytes = new Uint8Array(Module.HEAPU8.buffer, heapPointer, contentSize); heapBytes.set(contentArray); reader = null; contentArray = null; ccall("callFileDataReady", null, ["number", "number"], [heapPointer, contentSize]); }; reader.readAsArrayBuffer(file); } document.body.removeChild(fileElement); }; fileElement.click();}
};
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],init:function() {
        ...
        var pthreadMainJs = locateFile('lilyplayer.worker.js');
  ...
  function ___syscall_fchmod(fd, mode) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(5, 1, fd, mode);
  ...
  function ___syscall_ftruncate64(fd, length_low, length_high) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(8, 1, fd, length_low, length_high);
  ...
  function ___syscall_getcwd(buf, size) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(9, 1, buf, size);
  ...
  function ___syscall_mkdirat(dirfd, path, mode) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(13, 1, dirfd, path, mode);
  ...
  function ___syscall_newfstatat(dirfd, path, buf, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(14, 1, dirfd, path, buf, flags);
  ...
  function ___syscall_openat(dirfd, path, flags, varargs) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(15, 1, dirfd, path, flags, varargs);
  ...
  function ___syscall_readlinkat(dirfd, path, buf, bufsize) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(16, 1, dirfd, path, buf, bufsize);
  ...
  function ___syscall_renameat(olddirfd, oldpath, newdirfd, newpath) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(17, 1, olddirfd, oldpath, newdirfd, newpath);
  ...
  function ___syscall_rmdir(path) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(18, 1, path);
  ...
  function ___syscall_symlink(target, linkpath) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(20, 1, target, linkpath);
  ...
  function ___syscall_truncate64(path, length_low, length_high) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(21, 1, path, length_low, length_high);
  ...
  function ___syscall_unlinkat(dirfd, path, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(22, 1, dirfd, path, flags);
  ...
  function ___syscall_utimensat(dirfd, path, times, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(23, 1, dirfd, path, times, flags);
  ...
  function __mmap_js(addr, len, prot, flags, fd, off, allocated, builtin) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(24, 1, addr, len, prot, flags, fd, off, allocated, builtin);
  ...
  function __munmap_js(addr, len, prot, flags, fd, offset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(25, 1, addr, len, prot, flags, fd, offset);
  ...
  function _tzset_impl(timezone, daylight, tzname) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(26, 1, timezone, daylight, tzname);
  ...
  function _alBufferData(bufferId, format, pData, size, freq) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(27, 1, bufferId, format, pData, size, freq);
  ...
  function _alGenBuffers(count, pBufferIds) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(28, 1, count, pBufferIds);
  ...
  function _alGenSources(count, pSourceIds) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(29, 1, count, pSourceIds);
  ...
  function _alSourcePlay(sourceId) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(30, 1, sourceId);
  ...
  function _alSourceQueueBuffers(sourceId, count, pBufferIds) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(31, 1, sourceId, count, pBufferIds);
  ...
  function _alcOpenDevice(pDeviceName) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(36, 1, pDeviceName);
  ...
  function _emscripten_get_element_css_size(target, width, height) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(37, 1, target, width, height);
  ...
  function _environ_get(__environ, environ_buf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(50, 1, __environ, environ_buf);
  ...
  function _environ_sizes_get(penviron_count, penviron_buf_size) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(51, 1, penviron_count, penviron_buf_size);
  ...
  function _fd_close(fd) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(52, 1, fd);
  ...
  function _fd_fdstat_get(fd, pbuf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(53, 1, fd, pbuf);
  ...
  function _fd_read(fd, iov, iovcnt, pnum) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(54, 1, fd, iov, iovcnt, pnum);
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(55, 1, fd, offset_low, offset_high, whence, newOffset);
  ...
  function _fd_sync(fd) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(56, 1, fd);
  ...
  function _pthread_kill(thread, signal) {
      if (signal < 0 || signal >= 65/*_NSIG*/) return 28;
...
/** @type {function(...*):?} */
var _callFileDataReady = Module["_callFileDataReady"] = function() {
  return (_callFileDataReady = Module["_callFileDataReady"] = Module["asm"]["callFileDataReady"]).apply(null, arguments);
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 25215092;
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 25434060;
